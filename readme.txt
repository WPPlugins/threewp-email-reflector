...
The solution was to use a web hotel's SMTP server instead (see Debian package SSMTP). I think it has something to do with incorrectly set TXT DNS settings.
